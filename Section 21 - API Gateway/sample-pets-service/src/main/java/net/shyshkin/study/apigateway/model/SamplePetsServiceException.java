...
public class SamplePetsServiceException extends com.amazonaws.SdkBaseException implements BaseException {
    ...
    /**
     * Constructs a new SamplePetsServiceException with the specified error message.
     *
     * @param message
     *        Describes the error encountered.
     */
    public SamplePetsServiceException(String message) {
        super(message);
        this.message = message;
    }

    @Override
    public SamplePetsServiceException sdkHttpMetadata(SdkErrorHttpMetadata sdkHttpMetadata) {
